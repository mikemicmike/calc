...
const collections = {
  ...
  dragonkinI: {
    id: 'dragonkinI',
    label: 'Dragonkin I',
    collector: collectors.sharrigan,
    levelReq: 99,
  },
  dragonkinII: {
    id: 'dragonkinII',
  ...
  museumDragonkinI: {
    id: 'museumDragonkinI',
    label: 'Museum Dragonkin I',
    collector: collectors.velucia,
    levelReq: 99,
  },
  museumDragonkinII: {
    id: 'museumDragonkinII',
    label: 'Museum Dragonkin II',
    collector: collectors.velucia,
    levelReq: 102,
  },
  museumDragonkinIII: {
    id: 'museumDragonkinIII',
    label: 'Museum Dragonkin III',
    collector: collectors.velucia,
    levelReq: 108,
  },
  museumDragonkinIV: {
    id: 'museumDragonkinIV',
    label: 'Museum Dragonkin IV',
    collector: collectors.velucia,
    levelReq: 120,
  },
  museumSaradoministI: {
